...
def refresh_dashboard(app) -> None:
    ...
    try:
        from app.services.dashboard_service import refresh_dashboard as dashboard_refresh
...
def export_dashboard(app) -> None:
    ...
    from app.services.dashboard_service import export_dashboard as dashboard_export
    try:
...
def manual_adjustment(app) -> None:
    ...
    from app.services.dashboard_service import manual_adjustment as dashboard_manual
    try:
